...
public sealed class CommandAttribute(string description, bool defaultEnabled = true, uint defaultCooldown = 120, string defaultResponse = "", uint defaultRequiredBits = 0) : Attribute
{
