...
public sealed class TwitchTokenService(ILogger<TwitchTokenService> logger, ITwitchApiFactory apiFactory) : ITwitchTokenService
{
    public async Task<bool> ValidateAsync(string token)
    {
        ...
        try
        {
            ...
            return await api.ValidateAccessTokenAsync(token);
        }
        catch (Exception ex)
        {
